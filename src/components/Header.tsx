        ...
        <div className="flex justify-between items-center h-16">
          ...
          <nav className="hidden md:flex items-center space-x-1">
            ...
            <a 
              ...
              className="px-4 py-2 rounded-lg transition-all duration-200 font-medium text-sm text-gray-300 hover:text-white hover:bg-white/5"
            >
              Merch
            </a>
          </nav>
            ...
            <div className="relative h-full w-full glass-effect-strong shadow-2xl overflow-y-auto border-r border-white/10 bg-black/95">
              ...
              <nav className="px-4 py-5 space-y-2">
                ...
                <a 
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="group flex items-center justify-between px-5 py-3.5 rounded-xl text-white transition-all duration-200 font-medium text-sm glass-effect-subtle hover:bg-white/5 hover:border-white/10 border border-transparent"
                  onClick={() => setMobileMenuOpen(false)}
                >
                  <div className="flex items-center">
                    <div className="w-10 h-10 rounded-lg flex items-center justify-center mr-3 transition-all bg-white/5 border border-white/10 group-hover:bg-green-500/10 group-hover:border-green-500/20">
                      <ShoppingBag className="h-5 w-5 transition-colors text-gray-400 group-hover:text-green-400" />
                    </div>
